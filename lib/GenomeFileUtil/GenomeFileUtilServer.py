...
class Application(object):
    ...
    def __init__(self):
        ...
        self.rpc_service.add(impl_GenomeFileUtil.export_metagenome_features_protein_to_fasta,
                             name='GenomeFileUtil.export_metagenome_features_protein_to_fasta',
                             types=[dict])
        self.method_authentication['GenomeFileUtil.export_metagenome_features_protein_to_fasta'] = 'required'  # noqa
