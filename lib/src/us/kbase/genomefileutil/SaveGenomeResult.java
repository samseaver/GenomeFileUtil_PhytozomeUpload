...
/**
 * <p>Original spec-file type: SaveGenomeResult</p>
 * 
 * 
 */
...
public class SaveGenomeResult {
    ...
    public SaveGenomeResult withInfo(Tuple11 <Long, String, String, String, Long, String, Long, String, String, Long, Map<String, String>> info) {
        this.info = info;
        return this;
    }
    ...
    public java.lang.String toString() {
        return ((((("SaveGenomeResult"+" [info=")+ info)+", additionalProperties=")+ additionalProperties)+"]");
    }
