...
/**
 * <p>Original spec-file type: GenomeToGTFParams</p>
 * 
 * 
 */
...
public class GenomeToGTFParams {
    ...
    public GenomeToGTFParams withGenomeRef(java.lang.String genomeRef) {
        this.genomeRef = genomeRef;
        return this;
    }
    ...
    public GenomeToGTFParams withRefPathToGenome(List<String> refPathToGenome) {
        this.refPathToGenome = refPathToGenome;
        return this;
    }
    ...
    public java.lang.String toString() {
        return ((((((("GenomeToGTFParams"+" [genomeRef=")+ genomeRef)+", refPathToGenome=")+ refPathToGenome)+", additionalProperties=")+ additionalProperties)+"]");
    }
