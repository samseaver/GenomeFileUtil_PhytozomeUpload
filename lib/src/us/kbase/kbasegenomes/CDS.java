...
public class CDS {
    ...
    public CDS withFunctionalDescriptions(List<String> functionalDescriptions) {
        this.functionalDescriptions = functionalDescriptions;
        return this;
    }
    ...
    public CDS withAliases(List<Tuple2 <String, String>> aliases) {
        this.aliases = aliases;
        return this;
    }
    ...
    public CDS withDbXrefs(List<Tuple2 <String, String>> dbXrefs) {
        this.dbXrefs = dbXrefs;
        return this;
    }
    ...
    public java.lang.String toString() {
        return ((((((((((((((((((((((((((((((((((((((((("CDS"+" [id=")+ id)+", location=")+ location)+", md5=")+ md5)+", proteinMd5=")+ proteinMd5)+", parentGene=")+ parentGene)+", parentMrna=")+ parentMrna)+", note=")+ note)+", functions=")+ functions)+", functionalDescriptions=")+ functionalDescriptions)+", ontologyTerms=")+ ontologyTerms)+", flags=")+ flags)+", warnings=")+ warnings)+", inferenceData=")+ inferenceData)+", proteinTranslation=")+ proteinTranslation)+", proteinTranslationLength=")+ proteinTranslationLength)+", aliases=")+ aliases)+", dbXrefs=")+ dbXrefs)+", dnaSequence=")+ dnaSequence)+", dnaSequenceLength=")+ dnaSequenceLength)+", additionalProperties=")+ additionalProperties)+"]");
    }
