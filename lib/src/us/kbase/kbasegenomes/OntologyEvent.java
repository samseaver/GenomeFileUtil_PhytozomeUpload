...
public class OntologyEvent {
    ...
    public OntologyEvent withEco(String eco) {
        this.eco = eco;
        return this;
    }
    ...
    public String toString() {
        return ((((((((((((((("OntologyEvent"+" [id=")+ id)+", ontologyRef=")+ ontologyRef)+", method=")+ method)+", methodVersion=")+ methodVersion)+", timestamp=")+ timestamp)+", eco=")+ eco)+", additionalProperties=")+ additionalProperties)+"]");
    }
