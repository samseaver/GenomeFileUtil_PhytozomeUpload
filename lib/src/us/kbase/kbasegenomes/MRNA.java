...
public class MRNA {
    ...
    public MRNA withFunctionalDescriptions(List<String> functionalDescriptions) {
        this.functionalDescriptions = functionalDescriptions;
        return this;
    }
    ...
    public MRNA withAliases(List<Tuple2 <String, String>> aliases) {
        this.aliases = aliases;
        return this;
    }
    ...
    public MRNA withDbXrefs(List<Tuple2 <String, String>> dbXrefs) {
        this.dbXrefs = dbXrefs;
        return this;
    }
    ...
    public java.lang.String toString() {
        return ((((((((((((((((((((((((((((((((((("MRNA"+" [id=")+ id)+", location=")+ location)+", md5=")+ md5)+", parentGene=")+ parentGene)+", cds=")+ cds)+", dnaSequence=")+ dnaSequence)+", dnaSequenceLength=")+ dnaSequenceLength)+", note=")+ note)+", functions=")+ functions)+", functionalDescriptions=")+ functionalDescriptions)+", ontologyTerms=")+ ontologyTerms)+", flags=")+ flags)+", warnings=")+ warnings)+", inferenceData=")+ inferenceData)+", aliases=")+ aliases)+", dbXrefs=")+ dbXrefs)+", additionalProperties=")+ additionalProperties)+"]");
    }
